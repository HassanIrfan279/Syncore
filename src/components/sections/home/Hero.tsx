...
export function Hero() {
  return (
    <section
      className="hero-dark relative flex items-center overflow-hidden pt-24 sm:pt-28 lg:min-h-svh"
    ...
    >
      ...
      <div className="container-site relative z-10 grid items-center gap-10 pb-12 pt-8 sm:gap-14 sm:pb-16 sm:pt-10 lg:grid-cols-[minmax(0,1fr)_minmax(25rem,0.88fr)] lg:gap-16 lg:pb-24 lg:pt-20">
        ...
        <div className="relative mx-auto w-full max-w-md sm:max-w-xl lg:max-w-none">
          ...
          >
            <div className="neural-dot left-[12%] top-[18%] hidden sm:block" aria-hidden="true" />
            <div className="neural-dot right-[15%] top-[34%] hidden sm:block" aria-hidden="true" />
            <div className="neural-dot bottom-[18%] left-[38%] hidden sm:block" aria-hidden="true" />
            <div
              className="neural-line left-[16%] top-[21%] hidden w-[42%] rotate-[10deg] sm:block"
              aria-hidden="true"
            />
            <div
              className="neural-line right-[16%] top-[38%] hidden w-[34%] rotate-[138deg] sm:block"
              aria-hidden="true"
            />

            <div className="relative rounded-[1rem] border border-white/10 bg-brand-charcoal/72 p-2.5 shadow-2xl backdrop-blur-xl min-[380px]:p-3 sm:p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-2 min-[420px]:grid-cols-2 sm:mt-5 sm:gap-3">
                {dashboardCards.map((card) => {
                  ...
                  return (
                    <div
                      key={card.label}
                      className="group flex min-h-[7.5rem] flex-col justify-between rounded-2xl border border-white/10 bg-white/[0.075] p-3 shadow-[inset_0_1px_0_rgb(255_255_255/0.08)] transition duration-300 hover:-translate-y-1 hover:border-brand-cyan/50 hover:bg-white/[0.105] hover:shadow-[0_1rem_2.5rem_rgb(0_188_212/0.12)] min-[420px]:min-h-[9.75rem] sm:min-h-[11.25rem] sm:p-4"
                    >
                      ...
                      <div>
                        <p className="font-heading text-2xl font-extrabold leading-none text-brand-white sm:text-3xl">
                          {card.value}
                        </p>
              ...
              <div className="mt-4 grid gap-3 min-[420px]:grid-cols-[0.82fr_1fr]">
                <div className="rounded-2xl border border-white/14 bg-brand-charcoal/82 px-4 py-3 text-brand-white shadow-2xl backdrop-blur-xl">
                ...
                <div className="rounded-2xl border border-white/14 bg-white/10 px-4 py-3 text-brand-white shadow-2xl backdrop-blur-xl">
